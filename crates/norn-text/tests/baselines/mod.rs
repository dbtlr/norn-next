...
//!
//! Both bands below are `Document::parse` over a flat mapping of a stated key
//! count, best of five timed samples after three warm ones. Repeated local
...
/// reads as one diff.
pub use norn_testkit::readings::{multiple, per_mille, record};
