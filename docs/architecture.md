...
and each candidate's suffix probe, all seeks of the raw or folded suffix key the root
probes; the document's headings and its block definition, seeks of their
