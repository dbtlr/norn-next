...
concern ([ADR 0027](decisions/0027-class-scoped-link-health-rides-the-changeset.md)), so
...
([ADR 0027](decisions/0027-class-scoped-link-health-rides-the-changeset.md)) reads change through:
...
12. **Inference cannot reach findings or plans.** No `embed → store` and no `embed → fs`
    ...
    lane-1 store ([ADR 0027](decisions/0027-class-scoped-link-health-rides-the-changeset.md)). The
...
0027](decisions/0027-class-scoped-link-health-rides-the-changeset.md)). Vectors are versioned,
...
0027](decisions/0027-class-scoped-link-health-rides-the-changeset.md): its inputs are a document's
...
0027](decisions/0027-class-scoped-link-health-rides-the-changeset.md). The presence and value rows:
