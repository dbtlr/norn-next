...
graph LR
  ...
  subgraph hostp["host process — supervised service or TTL instance"]
    ...
    subgraph v1["vault entry (per registered vault, lazy attach)"]
      ...
      orch --> sidecar[("semantic sidecar — document_vectors (norn-semantic)")]
